...
$(document).ready(function(){
  ...
  $(".animated-words").each(function() {
    ...
    if ($this.find('.animated-words__item--archive').length > 0) {
      ...
      gsap.fromTo($this.find(".animated-words__item--one.animated-words__item--archive"), 
      ...
      gsap.fromTo($this.find(".animated-words__item--two.animated-words__item--archive"), 
        { x: startPositionArchive }, 
        { x: '0%', 
          immediateRender: false,
          scrollTrigger: {
      ...
      gsap.fromTo($this.find(".animated-words__item--one"), 
        { x: `-${startPosition}` }, 
        { x: '0%', 
          immediateRender: false,
          scrollTrigger: {
      ...
      gsap.fromTo($this.find(".animated-words__item--two"), 
        { x: startPosition }, 
        { x: '0%', 
          immediateRender: false,
          scrollTrigger: {
