...
<div class="contact">
    <div class="container">
        ...
        <?php if (!empty($locationsGroupedByCountry)) : ?>
            <div class="contact__wrapper">
                ...
                ?>
                                <button type="button" class="<?php echo esc_attr($countryButtonClassesString); ?>" data-country="<?php echo esc_attr($countryKeyString); ?>"><?php echo esc_html($countryLabelString); ?></button>
                                <?php $isFirstCountry = false; endforeach; ?>
                            </div>
                ...
                ?>
                                <div class="<?php echo esc_attr($locationsGroupClassesString); ?>" data-country="<?php echo esc_attr($countryKeyString); ?>">
                                    <?php
                    ...
                    ?>
                                    <button type="button" class="<?php echo esc_attr($locationButtonClassesString); ?>" data-location-id="<?php echo esc_attr($locationIdString); ?>" id="<?php echo esc_attr($locationIdString); ?>"><?php echo esc_html($regionNameString); ?></button>
                                    <?php $isFirstLocationInCountry = false; endforeach; ?>
                                </div>
                                <?php $isFirstCountry = false; endforeach; ?>
                            </div>
                        </div>
                            ...
                            <div class="location-info location-info--contact">
                                ...
                                <div class="location-info__content">
                                    <?php if ($addressHtmlString !== '') : ?>
                                        <span class="location-info__address"><?php echo wp_kses_post($addressHtmlString); ?></span>
                                    <?php endif; ?>
                                    <?php if (!empty($locationItem['phone'])) : ?>
                                        <a class="location-info__phone" href="<?php echo esc_url($locationItem['phone']['url']); ?>">
                                            <?php esc_html_e('Phone: ', 'fingleton'); ?>
                                            <span><?php echo esc_html($locationItem['phone']['title']); ?></span>
                                        </a>
                                    <?php endif; ?>
                                    <?php if (!empty($locationItem['email'])) : ?>
                                        <a class="location-info__email" href="<?php echo esc_url($locationItem['email']['url']); ?>">
                                            <?php esc_html_e('Email: ', 'fingleton'); ?>
                                            <span><?php echo esc_html($locationItem['email']['title']); ?></span>
                                        </a>
                                    <?php endif; ?>
                                    <?php if (!empty($locationItem['website'])) : ?>
                                        <a class="location-info__website" href="<?php echo esc_url($locationItem['website']['url']); ?>" target="_blank" rel="noopener"><?php echo esc_html($locationItem['website']['title']); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        <?php $isFirstLocationInCountry = false; endforeach; $isFirstCountry = false; endforeach; ?>
                    </div>
    ...
    <?php if(!empty($sentence_one) && !empty($sentence_two)): ?>
        <div class="animated-words animated-words--contact">
            <div class="animated-words__item animated-words__item--one"><?php echo wp_get_attachment_image($sentence_one, 'full'); ?></div>
            <div class="animated-words__item animated-words__item--two"><?php echo wp_get_attachment_image($sentence_two, 'full'); ?></div>
        </div>
    <?php endif; ?>
</div>
