    ...
    <div class="row achievements__intro-row">
      <div class="col-12 col-lg-5">
        ...
        <?php if(!empty($description)): ?>
          <div class="achievements__description paragraph">
            <?php echo apply_filters('acf_the_content', $description); ?>
          </div>
        <?php endif; ?>
      </div>
      ...
      <div class="row achievements__gallery-row achievements__gallery-row--bottom">
        <div class="col-12 col-lg-4">
          <div class="achievements__column-content">
            <div class="achievements__image-wrapper achievements__image-wrapper--small">
               <?php echo wp_get_attachment_image($gallery_image_small, 'medium', false, ['class' => 'img-fluid']); ?>
            </div>
        ...
        <div class="col-12 col-lg-8">
          <div class="achievements__image-wrapper achievements__image-wrapper--big">
            <?php echo wp_get_attachment_image($gallery_image_big, 'full', false, ['class' => 'img-fluid']); ?>
          </div>
        </div>
      </div>
