...
<?php if('true' == $left_column_negative_margin) { echo 'two-columns-content--negative-margin'; } ?>
<?php if('true' == $right_column_negative_margin) { echo 'two-columns-content--negative-margin'; } ?>">
