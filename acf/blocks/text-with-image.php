...
<div class="text-with-image <?php if(!empty($image_decorator)) { echo 'text-with-image--padding'; }?>">
  ...
  <div class="container">
    <div class="row text-with-image__row <?php if('reverse' == $direction) { echo 'text-with-image__row--reverse'; }?>">
      ...
      <div class="col-12 col-lg-6">
        <div class="text-with-image__picture <?php if('reverse' == $direction) { echo 'text-with-image__picture--reverse'; }?> <?php if('bigger' == $image_size) { echo 'text-with-image__picture--bigger'; }?>">
          <?php echo wp_get_attachment_image($image, 'full', '', ['class' => $image_class]);?>
          <div class="text-with-image__decorator">
            <?php echo wp_get_attachment_image($image_decorator, 'full', '', ['class' => '']);?>
          </div>
        </div>
      </div>
    </div>
