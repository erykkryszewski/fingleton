...
?>
               ...
               ?>
                ...
                <div class="product-remove">
                  <?php echo apply_filters(
                      ...
                      sprintf(
                          '<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s">Remove product</a>',
    ...
    <div class="cart-collaterals">
     ...
     do_action("woocommerce_cart_collaterals"); ?>
			<a href="/shop" class="button button--continue-shopping"><?php _e("Go to shop", "fingleton"); ?></a>
    </div>
  </div>
</div>
