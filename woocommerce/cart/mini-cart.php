...
<?php else : ?>
	<div class="flying-cart-content empty">
		<p><?php _e('Your cart is empty', 'fingleton'); ?></p>
		<p><?php _e('Go shopping', 'fingleton'); ?></p>
		...
		<a href="<?php echo get_the_permalink($shop_page_id); ?>" class="button"><?php _e('Browse products', 'fingleton'); ?></a>
	</div>
<?php endif; ?>
</div>
