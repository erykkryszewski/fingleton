            ...
            <nav class="nav <?php if(!is_front_page()) { echo 'nav--subpage'; } ?>">
                <div class="container-fluid container-fluid--padding nav__container">
                    <?php if(is_front_page()): ?>
                        <a href="/" class="nav__logo"><?php echo wp_get_attachment_image($global_logo, 'logo-sign', '', ["class" => ""]); ?></a>
                    <?php else: ?>
                        <a href="/" class="nav__logo"><?php echo wp_get_attachment_image($subpage_logo, 'logo-sign', '', ["class" => ""]); ?></a>
                    <?php endif; ?>
                    ...
                    <div class="nav__wrapper">
                        <div class="nav__content">
                            <div class="row nav__row m-0">
                                <div class="col-lg-3 p-0"><?php echo wp_nav_menu(['theme_location' => 'Navigation', 'container' => 'ul', 'menu_class' => 'nav__menu']); ?></div>
